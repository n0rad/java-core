...
public class ApplicationVersionTest {
    ...
    public void should_compare_version() throws Exception {
        ApplicationVersion appVersion = new ApplicationVersion(Version.V(2), (Update) null);
        ApplicationVersion appVersion2 = new ApplicationVersion(Version.V(3), (Update) null);
    ...
    public void should_accept_single_varargs() throws Exception {
        ApplicationVersion appVersion = new ApplicationVersion(Version.V(2), new Update("up") {
            @Override
    ...
    public void should_not_accept_same_update_name() throws Exception {
        new ApplicationVersion(Version.V(2), new Update("up") {
            @Override
            public void runUpdate() {
            }
        }, new Update("up") {
    ...
    public void should_find_names() throws Exception {
        List<String> updateNames = new ApplicationVersion(Version.V(2), new Update("up") {
            @Override
            public void runUpdate() {
            }
        }, new Update("up2") {
        ...
        Assertions.assertThat(updateNames).containsSequence("up", "up2");
